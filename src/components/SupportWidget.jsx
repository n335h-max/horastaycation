  ...
  return (
    <>
      ...
      <div className="fixed bottom-4 right-4 z-50 flex max-w-[calc(100vw-2rem)] flex-col items-end gap-3">
        {open ? (
          <div className="w-full max-w-sm rounded-[1.75rem] border border-brand-100 bg-white p-5 shadow-2xl">
            <div className="flex items-start justify-between gap-3">
              ...
              <button
                type="button"
                onClick={onClose}
                className="flex h-10 w-10 items-center justify-center rounded-full bg-ice-100 text-slate-500"
